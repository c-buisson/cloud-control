...
sudo scripts/check_url.sh https://$3:4443/knife_admin_key.tar.gz 300
sudo curl -o $2/$1/knife_admin_key.tar.gz -Ok https://$3:4443/knife_admin_key.tar.gz
